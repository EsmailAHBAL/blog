...
const title = process.env.NEXT_PUBLIC_SITE_NAME || "Web Leader";
const description =
...
const SEOHead: React.FunctionComponent<Props> = ({ aritclenName }) => {
  return (
    <NextHead>
      <title>{aritclenName ? `${title} : ${aritclenName}` : title}</title>
